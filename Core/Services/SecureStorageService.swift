...
// MARK: - BirthData Extension

extension BirthData: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        birthTime = try container.decodeIfPresent(String.self, forKey: .birthTime) ?? "12:00"
        ...
        timeUnknown = try container.decodeIfPresent(Bool.self, forKey: .timeUnknown) ?? false
    }
